...
if __name__ == '__main__':
    ...
    year=2020 # Setting the target year.
    month=6
    day=1
    startday=judge_daynumber(year,month,day)
    endday=startday+92
    # Get 21 nc files' paths of different models for the given year (Here is 2020)
    year_string=str(year)
    file_match=[]
    Input_folder = r'G:\GDDP-NEX-Prec\original\rcp45' # need to modify the path where you store the data on your laptop
    ...
    for item in range(len(match_nc_name)):
        ...
        # Consider adjust the row and column number based on your own study area size. Here 14 and 16 is identified with the position of PLEEZ in the tif.
